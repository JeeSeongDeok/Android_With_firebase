...
public class negative_fragment_open extends Fragment {
    ...
    public negative_fragment_open(){}

    public static negative_fragment_open newInstance(String param1, String param2) {
        negative_fragment_open fragment = new negative_fragment_open();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(bundle != null){
            ar = bundle.getStringArrayList("negative");
            ar1 = bundle.getStringArrayList("negative_word");
            find_str = ar1.get(0);
            // 레디오버튼 세팅
            for (int i = 0; i < 10; i++) {
                // 텍스트 설정
